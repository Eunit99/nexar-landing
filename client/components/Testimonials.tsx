        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8">
          <div className="flex flex-col gap-5">
            ...
            <h2 className="font-poppins text-5xl sm:text-6xl lg:text-[72px] font-extrabold leading-[105%] tracking-tight text-[#101828]">
              Nexar makes<br />everyone <span className="font-poppins text-[#674EF7]">happy.</span>
            </h2>
          </div>
          <Button
            variant="outline"
            size="lg"
            className="font-tt-norms rounded-full px-10 h-14 border-[#674EF7] text-[#674EF7] hover:bg-[#674EF7] hover:text-white transition-all font-bold"
          >
            Register Now
          </Button>
        </div>
