      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-14 py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              <a href="mailto:support@shawnsms.com" className="font-tt-norms flex items-center gap-3 text-[16px] text-white/90 hover:text-white transition-colors">
                <Mail className="w-6 h-6" />
                <span className="font-tt-norms">support@shawnsms.com</span>
              </a>
              <a href="#" className="font-tt-norms flex items-center gap-3 text-[16px] text-white/90 hover:text-white transition-colors">
                <MessageSquare className="w-6 h-6 rotate-[270deg]" />
                <span className="font-tt-norms">Whatsapp live chat</span>
              </a>
              <a href="#" className="font-tt-norms flex items-center gap-3 text-[16px] text-white/90 hover:text-white transition-colors">
                <Send className="w-6 h-6" />
                <span className="font-tt-norms">Email Support</span>
              </a>
            </div>
          </div>
